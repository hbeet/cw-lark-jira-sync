...
export function createConfig(env = process.env, baseDir = process.cwd()) {
  ...
  return {
    ...
    event: {
      ...
      encryptedSecretFile: env.LARK_APP_SECRET_ENC_FILE || `/Users/bin/Library/Application Support/lark-cli/appsecret_${eventAppId || "cli_aa9fd7b033f89e15"}.enc`,
      masterKeyFile: env.LARK_MASTER_KEY_FILE || "/Users/bin/Library/Application Support/lark-cli/master.key.file",
    },
    incremental: {
